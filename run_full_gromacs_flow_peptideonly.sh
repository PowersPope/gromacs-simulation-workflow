...
if [ "$resume_flag" = true ]; then
    ...
    # gmx make_ndx -f  struc_solv.gro 2> ndx_error.log
...
run_production() {
    ...
    echo "Taking md_0_1.xtc and centering to remove PBC... produces md_0_1_fit.xtc."
    printf "1\n0\n" | gmx trjconv -s md_0_1.tpr -f md_0_1.xtc -o md_0_1_fit.xtc -pbc mol -center

    # # Energy calculation steps.
    # gmx grompp -f md_energy.mdp -c md_0_1.gro \
    #           -p topol.top -o md_0_1_energy.tpr  
...
echo "Production run and centering complete."
